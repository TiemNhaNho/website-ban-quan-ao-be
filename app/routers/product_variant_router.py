...
@router.post("/product-variants", tags=["product-variants"], description="Create a new product variant", response_model=DataResponse[ProductVariantSchema], dependencies=[Depends(require_admin)])
...
@router.put("/product-variants/{variant_id}", tags=["product-variants"], description="Update a product variant by id", response_model=DataResponse[ProductVariantSchema], dependencies=[Depends(require_admin)])
...
@router.delete("/product-variants/{variant_id}", tags=["product-variants"], description="Delete a product variant by id", response_model=DataResponse[None], dependencies=[Depends(require_admin)])
...
@router.patch("/product-variants/{variant_id}", tags=["product-variants"], description="Update stock quantity of a product variant", response_model=DataResponse[ProductVariantSchema], dependencies=[Depends(require_admin)])
