...
@router.get("/suppliers", tags=["suppliers"], description="Get all suppliers", response_model=DataResponse[list[SupplierSchema]])
...
@router.get("/suppliers/{supplier_id}", tags=["suppliers"], description="Get a supplier by id", response_model=DataResponse[SupplierSchema])
...
@router.post("/suppliers", tags=["suppliers"], description="Create a new supplier", response_model=DataResponse[SupplierSchema])
...
@router.put("/suppliers/{supplier_id}", tags=["suppliers"], description="Update a supplier by id", response_model=DataResponse[SupplierSchema])
...
@router.delete("/suppliers/{supplier_id}", tags=["suppliers"], description="Delete a supplier by id", response_model=DataResponse[None])
