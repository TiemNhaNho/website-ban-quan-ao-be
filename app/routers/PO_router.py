...
@router.get("/purchase-orders", tags=["purchase-orders"], description="Get all purchase orders", response_model=DataResponse[list[PurchaseOrderSchema]])
...
@router.post("/purchase-orders", tags=["purchase-orders"], description="Create a new purchase order", response_model=DataResponse[PurchaseOrderSchema])
...
@router.get("/purchase-orders/{purchase_order_id}", tags=["purchase-orders"], description="Get a purchase order by id", response_model=DataResponse[PurchaseOrderSchema])
...
@router.delete("/purchase-orders/{purchase_order_id}", tags=["purchase-orders"], description="Delete a purchase order by id", response_model=DataResponse[PurchaseOrderSchema])
...
@router.put("/purchase-orders/{purchase_order_id}", tags=["purchase-orders"], description="Update a purchase order by id", response_model=DataResponse[PurchaseOrderSchema])
